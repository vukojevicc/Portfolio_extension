...
class __TwigTemplate_0519849225b47b250ca7a480262e665a0040385414bee665da6d143cf99637a8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["leader"]) {
                ...
                // line 27
                echo "\t\t<li class=\"row";
                if ((twig_get_attribute($this->env, $this->source, $context["leader"], "S_ROW_COUNT", [], "any", false, false, false, 27) % 2 == 1)) {
                    echo " bg1";
                } else {
                    echo " bg2";
                }
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["member"]) {
                ...
                // line 59
                echo "\t\t<li class=\"row";
                if ((twig_get_attribute($this->env, $this->source, $context["member"], "S_ROW_COUNT", [], "any", false, false, false, 59) % 2 == 1)) {
                    echo " bg1";
                } else {
                    echo " bg2";
                }
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["pending"]) {
                ...
                // line 95
                echo "\t\t<li class=\"row";
                if ((twig_get_attribute($this->env, $this->source, $context["pending"], "S_ROW_COUNT", [], "any", false, false, false, 95) % 2 == 1)) {
                    echo " bg1";
                } else {
                    echo " bg2";
                }
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["nonmember"]) {
                ...
                // line 129
                echo "\t\t<li class=\"row";
                if ((twig_get_attribute($this->env, $this->source, $context["nonmember"], "S_ROW_COUNT", [], "any", false, false, false, 129) % 2 == 1)) {
                    echo " bg1";
                } else {
                    echo " bg2";
                }
