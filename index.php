    ...
    <div class="overflow">
        ...
        <body>
                    ...
                    <ul class="navigation">
                        <a href="https://stackoverflow.com/users/13468559/aleksandar" target="_blank">
                            <li class="social-title">
                                ...
                                <span class="social-title-text bottom-tooltip">Stack Overflow</span>
                            </li>
                        </a>
                        <a href="https://github.com/vukojevicc/" target="_blank">
                            <li class="social-title">
                                <i class="fab fa-github fa-2x"></i>
                                <span class="social-title-text bottom-tooltip">GitHub</span>
                            </li>
                        </a>
                        ...
                        <a href="https://www.linkedin.com/in/aleksandar-vukojevic-b039b0209/" target="_blank">
                            <li class="social-title">
            ...
            <header class="main-header header">
                <div class="header-container">
                    ...
                    <ul class="navigation" id="main-menu">
                        ...
                        <a href="#projects" class="anchor-scroll">
                            <li>projects</li>
                        </a>
            ...
            <main>
                ...
                <div class="languages">
                    <div class="container">
                        <div class="card card1 vertical-alignment-parent fade">
                            <h2>front&nbsp;end</h2>
                        ...
                        <div class="card card2 vertical-alignment-parent fade">
                            <h2>server</h2>
                            <div class="vertical-alignment">
                                <img src="imgs/php.png" alt="php">
                            </div>
                        </div>
                        <div class="card card3 vertical-alignment-parent fade">
